package com.project.park_api.web.exception;
...
public class ApiExceptionHandler {
    ...
    public ResponseEntity<ErrorMessage> methoArgumentNotValidException(MethodArgumentNotValidException ex, HttpServletRequest request, BindingResult result) {
